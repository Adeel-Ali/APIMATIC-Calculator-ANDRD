 ...
 *
 * This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io ) on 10/07/2016
 */
...
public class SimpleCalculatorController extends BaseController {    
    ...
    public void getCalculateAsync(
        ...
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5685618145229600608L;
            {
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5078264107494873813L;
            {
                    put( "x", input.getX() );
                    put( "y", input.getY() );
            }});
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4749146564465222021L;
            {
